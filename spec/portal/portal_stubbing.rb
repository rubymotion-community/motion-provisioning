...
# https://github.com/fastlane/fastlane/blob/master/spaceship/spec/portal/portal_stubbing.rb
...
def adp_read_binary_fixture_file(filename)
  File.binread(File.join('spec', 'portal', 'fixtures', filename))
end
...
def adp_stub_certificates
  ...
  # When looking for development certificates only:
  stub_request(:post, "https://developer.apple.com/services-account/QH65B2/account/ios/certificate/listCertRequests.action").
  ...
  # When looking for distribution certificates only:
  stub_request(:post, "https://developer.apple.com/services-account/QH65B2/account/ios/certificate/listCertRequests.action").
